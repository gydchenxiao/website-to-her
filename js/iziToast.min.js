        ...
        p.toast.setAttribute("data-iziToast-ref", s.ref),
          ...
          (function () {
            if (
              ...
              o || window.innerWidth <= d
                ...
                : s.transitionIn && p.toast.classList.add(s.transitionIn),
              s["class"])
            ) {
              var t = s["class"].split(" ");
              m(t, function (t, e) {
          ...
          (function () {
            s.image &&
              ...
              s.rtl
                ? (p.toastBody.style.marginRight = s.imageWidth + 10 + "px")
                : (p.toastBody.style.marginLeft = s.imageWidth + 10 + "px"),
          ...
          (function () {
            s.iconUrl
              ...
              : s.icon &&
                ...
                s.iconText &&
                  p.icon.appendChild(document.createTextNode(s.iconText)),
            ...
            s.title.length > 0 &&
              ...
              s.titleSize &&
                (isNaN(s.titleSize)
                  ...
                  : (p.strong.style.fontSize = s.titleSize + "px")),
              s.titleLineHeight &&
                (isNaN(s.titleSize)
                  ? (p.strong.style.lineHeight = s.titleLineHeight)
                  : (p.strong.style.lineHeight = s.titleLineHeight + "px"))),
              s.message.length > 0 &&
                ...
                s.messageSize &&
                  (isNaN(s.titleSize)
                    ...
                    : (p.p.style.fontSize = s.messageSize + "px")),
                s.messageLineHeight &&
                  (isNaN(s.titleSize)
                    ? (p.p.style.lineHeight = s.messageLineHeight)
                    : (p.p.style.lineHeight = s.messageLineHeight + "px"))),
              s.title.length > 0 &&
                s.message.length > 0 &&
                (s.rtl
              ...
              (null !== document.querySelector("." + n + "-overlay.fadeIn")
                ? ((p.overlay = document.querySelector("." + n + "-overlay")),
                  p.overlay.setAttribute(
                    "data-iziToast-ref",
                    p.overlay.getAttribute("data-iziToast-ref") + "," + s.ref
                  ),
                  isNaN(s.zindex) ||
                    null === s.zindex ||
